...
import com.plcoding.cryptotracker.feature_crypto.presentation.coin_list.CoinListState
import com.plcoding.cryptotracker.feature_crypto.presentation.coin_list.components.previewCoin
import com.plcoding.cryptotracker.feature_crypto.presentation.models.toDisplayableNumber
...
fun CoinDetailScreen(
    ...
    val contentTextColor = if (isSystemInDarkTheme()){
        Color.White
    } else {
        Color.Black
    }
    ...
    if (state.isLoading) {
        ...
        Column (
            ...
            Icon(
                imageVector = ImageVector.run { vectorResource(id = coin.iconRes) },
            ...
            FlowRow (
                ...
                InfoCard(
                    ...
                    formattedText = "$ ${coin.marketCapsUsd.formatted}",
            ...
            AnimatedVisibility(
                ...
                var amountOfVisibleDataPoints = if (labelWidth > 0) {
